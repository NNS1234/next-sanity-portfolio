    ...
    <div>
      ...
      <div className="items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
        ...
        <h2 className="mt-24  font-bold text-gray-700 text-3xl">About Me</h2>
          <p className="mb-7">
          Experienced Software Developer with 3+ years in frontend development. Proficient in Java, JavaScript, TypeScript, React.js, Node.js, and Next.js. Experienced in working with Docker and MYSQL, MongoDB & PostgreSQL. Skilled in designing user-centric interfaces and optimizing database performance. Strong problem-solving abilities with a focus on agile methodologies. Committed to continuous learning and collaborative teamwork.
          </p>
